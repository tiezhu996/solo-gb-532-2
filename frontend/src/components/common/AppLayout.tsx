...
const links=[{to:'/areas',label:'测区',icon:MapOutlined},{to:'/plans',label:'测线',icon:RouteOutlined},{to:'/runs',label:'航迹',icon:RadarOutlined},{to:'/replay',label:'回放',icon:ReplayRounded},{to:'/coverage',label:'覆盖',icon:AssessmentOutlined},{to:'/audit',label:'审计',icon:FactCheckOutlined,audit:true}]
