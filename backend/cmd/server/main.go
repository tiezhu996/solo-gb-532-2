...
func main() {
	...
	replayRepository := repository.NewRunReplayRepository(db)
	...
	replayService := service.NewRunReplayService(replayRepository, runRepository, auditService)
	...
	handlers := router.Handlers{
		...
		Coverage: handler.NewCoverageGapHandler(coverageService), Replay: handler.NewRunReplayHandler(replayService),
